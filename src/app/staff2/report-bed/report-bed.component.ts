      ...
      if (rs.ok) {
        ...
        for (const i of this.list) {
          for (const a of i.provinces) {
            ...
            a.sum_lv21_covid_qty = sumBy(a.hospitals, 'lv21_covid_qty');
            a.sum_lv21_usage_qty = sumBy(a.hospitals, 'lv21_usage_qty');
            a.sum_lv21_inven_qty = sumBy(a.hospitals, 'lv21_covid_qty') - sumBy(a.hospitals, 'lv21_usage_qty');
            a.sum_lv22_covid_qty = sumBy(a.hospitals, 'lv22_covid_qty');
            a.sum_lv22_usage_qty = sumBy(a.hospitals, 'lv22_usage_qty');
            a.sum_lv22_inven_qty = sumBy(a.hospitals, 'lv22_covid_qty') - sumBy(a.hospitals, 'lv22_usage_qty');
