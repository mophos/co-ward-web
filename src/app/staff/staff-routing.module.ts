...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'covid-case', component: CovidCaseComponent },
      { path: 'covid-case-new', component: CovidCaseNewComponent },
      { path: 'covid-case-new-v2', component: CovidCaseNewV2Component },
      { path: 'covid-case-edit', component: CovidCaseEditComponent },
      { path: 'covid-case-old', component: CovidCaseOldComponent },
      { path: 'covid-case-update', component: CovidCaseUpdateComponent },
