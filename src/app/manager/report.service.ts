...
export class ReportService {
  ...
  async getSupplieExport(date, query = '', zone = '') {
    const url = `${this.apiUrl}/v2/report/get-supplies/export?date=${date}&query=${query}&zone=${zone}`;
  ...
  async getReportBedExcel() {
    const url = `${this.apiUrl}/v2/report/get-bed/excel/new`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }
  ...
  async provinceCaseDate(startDate, endDate) {
    const url = `${this.apiUrl}/v2/report/province-case-date?startDate=${startDate}&endDate=${endDate}`;
    return await this.http.get(url).toPromise();
  }

  async admitConfirmCase() {
    const url = `${this.apiUrl}/v2/report/admit-confirm-case`;
    return await this.http.get(url).toPromise();
  }

  async admitConfirmCaseSummary() {
    const url = `${this.apiUrl}/v2/report/admit-confirm-case-summary`;
    return await this.http.get(url).toPromise();
  }

  async admitPuiCase() {
    const url = `${this.apiUrl}/v2/report/admit-pui-case`;
    return await this.http.get(url).toPromise();
  }

  async admitPuiCaseSummary() {
    const url = `${this.apiUrl}/v2/report/admit-pui-case-summary`;
    return await this.http.get(url).toPromise();
  }

  async dischargeDaily(date) {
    const url = `${this.apiUrl}/v2/report/discharge-daily?date=${date}`;
    return await this.http.get(url).toPromise();
  }

  async dischargeDailyExport(date) {
    const url = `${this.apiUrl}/v2/report/discharge-daily/excel?date=${date}`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }

  async dischargeCaseEntryDate(date) {
    const url = `${this.apiUrl}/v2/report/discharge-entrydate?date=${date}`;
    return await this.http.get(url).toPromise();
  }

  async dischargeCaseEntryDateExport(date) {
    const url = `${this.apiUrl}/v2/report/discharge-entrydate/excel?date=${date}`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }

  async homework() {
    const url = `${this.apiUrl}/v2/report/homework`;
    return await this.http.get(url).toPromise();
  }

  async homeworkDetail(filter = 'all') {
    const url = `${this.apiUrl}/v2/report/homework-detail?filter=${filter}`;
    return await this.http.get(url).toPromise();
  }

  async getRecords() {
    const url = `${this.apiUrl}/v2/report/records`;
    return await this.http.get(url).toPromise();
  }

  async getLocalQuarantine() {
    const url = `${this.apiUrl}/v2/report/local-quarantine`;
    return await this.http.get(url).toPromise();
  }

  async getLocalQuarantineHotel() {
    const url = `${this.apiUrl}/v2/report/local-quarantine-hotel`;
    return await this.http.get(url).toPromise();
  }

  async summaryLocalQuarantineZone() {
    const url = `${this.apiUrl}/v2/report/summary-local-quarantine-zone`;
    return await this.http.get(url).toPromise();
  }

  async summaryLocalQuarantineZone2() {
    const url = `${this.apiUrl}/v2/report/summary-local-quarantine-zone/2`;
    return await this.http.get(url).toPromise();
  }

  async summaryLocalQuarantineProvince() {
    const url = `${this.apiUrl}/v2/report/summary-local-quarantine-province`;
    return await this.http.get(url).toPromise();
  }

  async getLabPositive() {
    const url = `${this.apiUrl}/v2/report/lab-positive`;
    return await this.http.get(url).toPromise();
  }
}
