...
export class ReportAllService {
  ...
  async getReport1(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report1?date=${date}`;
  ...
  async getReport2(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report2?date=${date}`;
    return await this.http.get(url).toPromise();
  }

  async getReport2Excel(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report2/excel?date=${date}`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }
  async getReport3(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report3?date=${date}`;
    return await this.http.get(url).toPromise();
  }

  async getReport3Excel(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report3/excel?date=${date}`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }
  async getReport4(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report4?date=${date}`;
    return await this.http.get(url).toPromise();
  }

  async getReport4Excel(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report4/excel?date=${date}`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }
  async getReport5(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report5?date=${date}`;
    return await this.http.get(url).toPromise();
  }

  async getReport5Excel(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report5/excel?date=${date}`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }
  ...
  async getReport8Excel(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report8/excel?date=${date}`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }
  async getReport9(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report9?date=${date}`;
    return await this.http.get(url).toPromise();
  }

  async getReport9Excel(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report9/excel?date=${date}`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }
  async getReport10(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report10?date=${date}`;
    return await this.http.get(url).toPromise();
  }

  async getReport10Excel(date, sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report10/excel?date=${date}`;
    return await this.http.get(url, { responseType: 'blob' }).toPromise();
  }

  async getReportReviewHomework(sector) {
    const url = `${this.apiUrl}/v1/manager/report-all/report-homework`;
    return await this.http.get(url).toPromise();
  }
