...
@Component({
  selector: 'app-report-dms10',
  templateUrl: './report-dms10.component.html',
  styles: []
})
export class ReportDms10Component implements OnInit {
  list: any;
  zone: any = '';
  date: any;
  ...
  async getList() {
    ...
    try {
      ...
      const rs: any = await this.reportService.getReport10(date, this.sector);
      if (rs.ok) {
